    ...
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                ...
                <a href="#" class="h3"><b>Login Pemohon - </b>MPP</a><br>
            </div>
            <div class="card-body">
                ...
                <form action="{{ url('pemohon/login') }}" method="post">
                    ...
                    <div class="input-group mb-3">
                        <input type="email" placeholder="Email" class="form-control @error('email') is-invalid @enderror"
                            id="email" name="email" autofocus required value="{{ old('email') }}">
                    ...
                    <div class="row">
                        <div class="col-4">
                            <a href="{{ url('pemohon/daftar') }}" class="btn btn-outline-primary btn-block">DAFTAR</a>
                        </div>
                        <div class="col-4"></div>
                        <!-- /.col -->
                        <div class="col-4">
                ...
                <div class="social-auth-links text-center mt-2 mb-3">
                    ...
                    <a class="mt-5"  href="{{ route('forget.password.get') }}">Lupa Kata Sandi</a>
                </div>
            </div>
            <!-- /.card-body -->
        </div>
